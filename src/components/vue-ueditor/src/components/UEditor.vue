  ...
  methods: {
    insertScriptTag () {
      ...
      if (editorScriptTag === null) {
        ...
        console.log('12342',this.ueditorPath);
    ...
    initEditor () {
      ...
      if (this.scriptTagStatus === 2 && this.instance === null) {
        ...
        let customScriptTag = document.getElementById('customScriptTag');
        if(customScriptTag==null){
          customScriptTag = document.createElement('script');
          customScriptTag.type = 'text/javascript'; customScriptTag.src = '/static/' + 'ueditor_custom.js'; customScriptTag.id = 'customScriptTag';
          let s = document.getElementsByTagName('head')[0];
          s.appendChild(customScriptTag);
        }
