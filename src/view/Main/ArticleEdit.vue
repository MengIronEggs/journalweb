...
<style>
    .ArticleEdit .el-tabs__nav-scroll{
        line-height: 0.12rem;
    }
    .ArticleEdit .el-tabs__item{
        font-size:0.07rem;
    }
    .ArticleEdit .el-input__inner{
        height: 0.2rem;
        line-height: 0.2rem;
        font-size:0.06rem;
    }
    .ArticleEdit  .fr-box.fr-basic.fr-top .fr-wrapper {
        height: 1.6rem !important;
    }
    .ArticleEdit .fr-box.fr-basic .fr-element{
...
<template>
    <div class="ArticleEdit" style="overflow-y:auto">
        <div class="container">
            <div class="tab-aside">
        ...
        >
           ...
           <p style="color: #f56c6c; font-size: 0.05rem">* 相同名称的模板会被覆盖</p>
